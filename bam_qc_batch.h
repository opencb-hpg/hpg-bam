...
/**
* @brief Structure for qc info
* 
* Structure containing qc info.
*/
typedef struct qc_info {
  //unsigned long strand_counter;
  //unsigned long map_quality;
  //long alignment_errors_histogram[5];
} qc_info_t;
...
typedef struct bam_qc_batch {
  ...
  qc_info_t* qc_info_p;			/**< Pointer to qc information. */
